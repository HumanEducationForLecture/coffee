	...
	<div id="breadcrumb">
		<div class="container">
			<div class="breadcrumb">
				<li class="active"><a href="buyList.jsp">Calendar</a></li>
		...
		<form name="calendarFrm" id="calendarFrm" action="" method="post">
			...
			<DIV id="content" style="width: 712px;">
				...
				<table border="0" cellspacing="1" cellpadding="1" bgcolor="#FFFFFF">
					...
					<TBODY>
						<TR>
							<c:forEach var="start" begin="1" end="${start }" step="1">
								<TD>&nbsp;</TD>
							${newLine+1 }
						</c:forEach>
							<c:forEach var="endDay" begin="1" end="${endDay }" step="1" varStatus="status">
								<c:choose>
